    ...
    <div class="container-md">
        <div class="row">
            <div class="col d-flex align-items-center my-4">
                ...
                <a class="btn btn-primary mx-1 d-flex align-items-center" href="{{ route('admin.projects.create') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <a class="btn btn-success mx-1 d-flex align-items-center" href="{{ route('admin.projects.trash') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
